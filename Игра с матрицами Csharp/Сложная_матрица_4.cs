...
{
    public partial class Сложная_матрица_4 : Form
    {
        float[,] matrix_result = new float[6, 6];
        int rnd_i_1, rnd_j_2;

        public Сложная_матрица_4()
        {
            InitializeComponent();
        }

        private void Сложная_матрица_4_Load(object sender, EventArgs e)
        {
            float[,] matrix_1 = new float[6, 6], matrix_2 = new float[6, 6];
            int i, j, cells_addition_cycle, rnd_j_1, rnd_i_2;

            Random rnd = new Random();
            rnd_j_1 = rnd.Next(3, 6);
            rnd_i_2 = rnd.Next(3, 6);
            do //генерация чисел для ранга матрицы
            {
                rnd_i_1 = rnd.Next(3, 6);
                rnd_j_2 = rnd.Next(3, 6);
        ...
        {
            float[,] matrix_result_check = new float[6, 6];
